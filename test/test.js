const DropboxStorage = artifacts.require('./DropboxStorage.sol')

require('chai')
  .use(require('chai-as-promised'))
  .should()

contract('DropboxStorage', ([deployer, uploader]) => {
  let dstorage

  before(async () => {
    dstorage = await DropboxStorage.deployed()
  })
  ...
  describe('deployment', async () => {
    ...
    it('has a name', async () => {
      ...
      assert.equal(name, 'DropboxStorage')
    })
  })
